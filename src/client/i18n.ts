...
const DICTS: Record<Lang, Dict> = {
  zh: {
    ...
    'field.botId': 'Bot ID',
    'platform.wechat': '微信智能机器人',
    'platform.wechat.hint': '基于腾讯官方微信智能机器人（iLink 协议）原生接入：直接点击「获取登录二维码」，使用手机微信扫码并确认登录，即可免公网 IP 实现个人微信「智能机器人」的实时双向对话！',
    'field.wechatBotToken': 'Bot Token',
    'field.wechatUserId': '微信用户 ID',
    'gateway.wechat.getQr': '获取微信扫码登录二维码',
    'gateway.wechat.qrHint': '请使用手机微信扫一扫确认登录',
    'gateway.wechat.scanning': '正在等待手机微信确认登录…',
    'gateway.wechat.scanSuccess': '微信登录成功！',
  ...
  en: {
    ...
    'platform.webhooks': 'Webhooks',
    'platform.wechat': 'WeChat Bot',
    'platform.wechat.hint': 'Native Tencent iLink protocol integration: click "Get QR code", scan with WeChat to confirm login, and chat directly with your personal WeChat "AI Bot" without public IP.',
    'field.wechatBotToken': 'Bot Token',
    'field.wechatUserId': 'WeChat User ID',
    'gateway.wechat.getQr': 'Get WeChat Login QR Code',
    'gateway.wechat.qrHint': 'Please scan with WeChat on your phone to confirm login',
    'gateway.wechat.scanning': 'Waiting for WeChat confirmation…',
    'gateway.wechat.scanSuccess': 'WeChat login successful!',
  ...
  es: {
    ...
    'platform.webhooks': 'Webhooks',
    'platform.wechat': 'Bot de WeChat',
    'platform.wechat.hint': 'Integración nativa del protocolo Tencent iLink: haz clic en "Obtener código QR", escanea con WeChat para confirmar el inicio de sesión y chatea directamente con tu "Bot de IA" sin IP pública.',
    'field.wechatBotToken': 'Token del Bot',
    'field.wechatUserId': 'ID de usuario de WeChat',
    'gateway.wechat.getQr': 'Obtener código QR de WeChat',
    'gateway.wechat.qrHint': 'Por favor escanea con WeChat para confirmar el inicio de sesión',
    'gateway.wechat.scanning': 'Esperando confirmación en WeChat…',
    'gateway.wechat.scanSuccess': '¡Inicio de sesión en WeChat exitoso!',
