...
const DICTS: Record<Lang, Dict> = {
  zh: {
    ...
    'platform.dingtalk': '钉钉群机器人',
    'platform.dingtalk.hint': '在钉钉群设置中添加「自定义机器人」，复制其 Webhook 地址填入；若开启了「加签」安全设置，请同时填入加签密钥 Secret。',
    'field.dingtalkWebhook.ph': 'https://oapi.dingtalk.com/robot/send?access_token=...',
    'field.dingtalkSecret': '加签密钥 (Secret，可选)',
    'platform.feishu': '飞书群机器人',
    'platform.feishu.hint': '在飞书群设置中添加「自定义机器人」，复制其 Webhook 地址填入；若开启了「签名校验」，请填入对应的签名密钥 Secret。',
    'field.feishuWebhook.ph': 'https://open.feishu.cn/open-apis/bot/v2/hook/...',
    'field.feishuSecret': '签名密钥 (Secret，可选)',
